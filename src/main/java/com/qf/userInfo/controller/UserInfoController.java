...
public class UserInfoController {
     ...
     * @return
     */
    @RequestMapping(value = "signIn", method = RequestMethod.POST) public String signin (@RequestBody UserInfo userInfo, HttpSession httpSession){
     ...
     * @return
     */
    @RequestMapping(value = "getUserPower", method = RequestMethod.POST) public int getUserPower (@RequestBody UserInfo userInfo){
     ...
     * @return
     */
    @RequestMapping(value = "getUserId", method = RequestMethod.POST) public int getUserId (@RequestBody UserInfo
